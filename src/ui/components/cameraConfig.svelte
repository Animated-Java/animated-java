<script lang="ts" context="module">
	...
	const TRANSLATIONS = {
		entity_type: {
			displayName: translate('animated_java.camera_config.entity_type'),
			description: translate('animated_java.camera_config.entity_type.description').split(
				'\n'
			),
			error: {
				unset: translate('animated_java.camera_config.entity_type.error.unset'),
				space: translate('animated_java.camera_config.entity_type.error.space'),
		...
		nbt: {
			displayName: translate('animated_java.camera_config.nbt'),
			description: translate('animated_java.camera_config.nbt.description').split('\n'),
		},
	}
</script>
...
<script lang="ts">
	...
	const settings: Record<string, AJ.Setting<any>> = {
		entity_type: new AJ.InlineTextSetting(
			{
				id: 'animated_java:camera_config/entity_type',
		...
		nbt: new AJ.CodeboxSetting(
			{
				id: 'animated_java:camera_config/nbt',
