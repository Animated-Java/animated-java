import { PACKAGE } from '../constants.ts'
import { activeProjectIsBlueprintFormat } from '../formats/blueprint/index.ts'
import { getItemModel } from '../systems/minecraft/itemModelManager.ts'
import { IDisplayEntityConfigs } from '../systems/rigRenderer.ts'
import EVENTS from '../util/events.ts'
import { validateItem } from '../util/minecraftUtil.ts'
import { registerAction } from '../util/moddingTools.ts'
import { DeepClonedObjectProperty, fixClassPropertyInheritance } from '../util/property.ts'
import { Valuable } from '../util/stores.ts'
import { translate } from '../util/translation.ts'
import { ResizableOutlinerElement } from './resizableOutlinerElement.ts'
import { sanitizeOutlinerElementName } from './util.ts'
