import { newSetting } from './settings'
	...
	marker: newSetting(
		{
			...
			description: translate('animatedJava.settings.marker.description'),
			dataType: 'boolean',
		},
		settingData => {
			return settingData
	...
	superSecret: newSetting(
		{
			...
			description: translate('animatedJava.settings.superSecret.description'),
			dataType: 'text',
			displayType: 'inline',
		},
		settingData => {
