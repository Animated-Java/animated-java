...
function computeMikkTSpaceTangents(geometry: any, MikkTSpace: any, negateSign = true) {
	...
	function getAttributeArray(attribute: any) {
 ...
 */
function mergeGeometries(geometries: any, useGroups = false) {
 ...
 */
function mergeAttributes(attributes: any) {
	let TypedArray
	let itemSize
	let normalized
	let gpuType = -1
 ...
 * @return {BufferAttribute}
 */
export function deepCloneAttribute(attribute: any) {
...
export function deinterleaveAttribute(attribute: any) {
...
export function deinterleaveGeometry(geometry: any) {
 ...
 * @return {number}
 */
function estimateBytesUsed(geometry: any) {
 ...
 * @return {BufferGeometry}
 */
function mergeVertices(geometry: any, tolerance = 1e-4) {
	...
	const tmpAttributes: any = {}
	const tmpMorphAttributes: any = {}
	const newIndices = []
	const getters = ['getX', 'getY', 'getZ', 'getW']
	const setters = ['setX', 'setY', 'setZ', 'setW']
 ...
 * @return {BufferGeometry}
 */
function toTrianglesDrawMode(geometry: any, drawMode: any) {
 ...
 */
function computeMorphedAttributes(object: any) {
...
function mergeGroups(geometry: any) {
 ...
 * @return {BufferGeometry}
 */
function toCreasedNormals(geometry: any, creaseAngle = Math.PI / 3 /* 60 degrees */) {
