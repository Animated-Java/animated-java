<script lang="ts" , context="module">
	...
	import ColorPicker from './components/dialogItems/colorPicker.svelte'
...
<script lang="ts">
	...
	const pluginModeEnvironment = Project?.animated_java?.environment === 'plugin'
