...
execute on passengers if entity @s[tag=aj.armor_stand.bone.right_leg2] run \
	data merge entity @s {transformation: [-1f,1.4824725996745888e-17f,1.2156407909304452e-16f,-0.125f,0f,0.9926460362096415f,-0.12105307429919744f,0.8063820645368942f,-1.2246467991473532e-16f,-0.12105307429919744f,-0.9926460362096415f,0.0193135621484342f,0f,0f,0f,1f], start_interpolation: 0}
# It's actually faster to use a single command like this than to spread it into a function.
execute on passengers if entity @s[tag=aj.armor_stand.bone.left_leg] run \
	data merge entity @s {transformation: [-1f,-1.4824725996745888e-17f,1.2156407909304452e-16f,0.125f,0f,0.9926460362096415f,0.12105307429919744f,0.6875f,-1.2246467991473532e-16f,0.12105307429919744f,-0.9926460362096415f,-0.0193135621484342f,0f,0f,0f,1f], start_interpolation: 0}