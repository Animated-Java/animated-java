...
execute unless entity @s[type=item_display,tag=aj.armor_stand.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'function_path': 'animated_java:armor_stand/animations/sitting/tween_play'}
function animated_java:armor_stand/animations/pause_all
tag @s add aj.armor_stand.animation.sitting.playing
...
$function animated_java:armor_stand/animations/sitting/zzz/apply_frame {frame: $(to_frame)}