...
# Variant Arguement
execute if data storage aj:temp args.variant run function animated_java:test_blueprint/zzz/10
# Animation, Frame, and Start Animation Arguments
execute if data storage aj:temp args.animation run function animated_java:test_blueprint/zzz/23
